"""Parser for enumeration value documentation pages."""

from __future__ import annotations

import re

from ..models import EnumValueInfo
from .base import PageParser
from .html_handler import ParsedPage


class EnumValuePageParser(PageParser):
    """Parses enum value documentation HTML pages."""

    def _build_result(self, page: ParsedPage) -> EnumValueInfo:
        info = EnumValueInfo()
